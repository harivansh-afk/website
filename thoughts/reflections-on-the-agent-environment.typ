...
#thought(
  ...
  #elem("p")[a parallel shift in my workflow has been moving away from running things locally. #link("https://git.harivan.sh/harivansh-afk/nix", [Nix]) let me define my entire environment declaratively which was pretty cool. This paired with Agent Computer, i can drop my entire dev setup - tools, skills, secrets - into a remote VM with one click.]
